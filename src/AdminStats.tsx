      ...
      <div className="max-w-6xl mx-auto py-8 px-2">
        <div className="flex justify-between items-center mb-10">
          <h1 className="text-4xl font-black flex items-center gap-2">
            ...
            <span className="bg-gradient-to-tr from-purple-700 to-blue-400 text-transparent bg-clip-text">{t('Statistics')}</span>
          </h1>
          <a
            href="/admin"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 flex flex-col">
            <h2 className="text-xl font-bold mb-3 text-purple-700">{t('Top Trips (Most Booked)')}</h2>
            <Bar data={tripCountsBar} options={chartOptions} />
          </div>
          {/* Top Profitable Trips */}
          <div className="bg-white rounded-3xl shadow-xl p-8 flex flex-col">
            <h2 className="text-xl font-bold mb-3 text-emerald-700">{t('Top Profitable Trips')}</h2>
            <Bar data={profitBar} options={chartOptions} />
          </div>
          {/* Male vs Female */}
          <div className="bg-white rounded-3xl shadow-xl p-8 flex flex-col">
            <h2 className="text-xl font-bold mb-3 text-blue-700">{t('Gender Distribution')}</h2>
          ...
          {/* Top Users */}
          <div className="bg-white rounded-3xl shadow-xl p-8 flex flex-col">
            <h2 className="text-xl font-bold mb-3 text-yellow-700">{t('Top Users')}</h2>
