  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200 to-indigo-300">
      <div className="w-full max-w-md bg-white/95 p-8 rounded-2xl shadow-2xl border border-blue-100">
        <h2 className="text-3xl font-bold text-center text-indigo-700 mb-6">{t('Welcome Back!')}</h2>
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block mb-1 text-sm font-medium text-gray-700">{t('Email or Username')}</label>
            <input
          ...
          {msg && <div className="text-center text-red-500 font-medium">{t(msg)}</div>}
          <button
            type="submit"
